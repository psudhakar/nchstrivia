...
with col1:
    st.markdown("#### Venmo")
    st.markdown("Click [here](https://venmo.com/Jayshri-Patel-5) or send it to `Jayshri-Patel-5`")
with col2:
    st.markdown("#### Zelle/PayPal")
    st.markdown("Send your payments to: `sudhakar.parsi@gmail.com`")
with col3:
    st.markdown("#### Cash App")
    st.markdown("Click [here](https://cash.app/$SudhakarParsi) or send it to `$SudhakarParsi`")
with col4:
    st.markdown("#### Check")
